...
| `children` | int | No | 0 | Number of children (aged 2-11) |
| `infants_in_seat` | int | No | 0 | Number of infants occupying their own seat |
| `infants_on_lap` | int | No | 0 | Number of infants travelling on an adult's lap |
