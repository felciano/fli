...
class SearchDates:
    ...
    def _price_one_date(
        ...
        *,
        ...
        # abort the whole chunk. Use the same UTC-anchored floor the segment
        # validator does, or a host running ahead of the traveler drops the
        # traveler's own today from the sweep.
