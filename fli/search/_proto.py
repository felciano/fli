...
def build_tfs_token(
    ...
    *,
    ...
    Args:
        ...
        passengers: Passenger kind codes, one entry per traveller, encoded
            as repeated field 8 (1 = adult, 2 = child, 3 = infant in seat,
            4 = infant on lap).  Defaults to a single adult so existing
