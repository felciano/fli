...
class FlightSearchParams(BaseModel):
    ...
    children: int = Field(0, ge=0, description="Number of children (aged 2-11)")
    infants_in_seat: int = Field(0, ge=0, description="Number of infants occupying their own seat")
    infants_on_lap: int = Field(
        0, ge=0, description="Number of infants travelling on an adult's lap"
    )
...
def search_flights(
    ...
    children: Annotated[
        int,
        Field(description="Number of children (aged 2-11)", ge=0),
    ] = 0,
    infants_in_seat: Annotated[
        int,
        Field(description="Number of infants occupying their own seat", ge=0),
    ] = 0,
    infants_on_lap: Annotated[
        int,
        Field(description="Number of infants travelling on an adult's lap", ge=0),
    ] = 0,
